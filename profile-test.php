<?php
    ...
    $sql2 = "SELECT * FROM home WHERE member_id = '$ss_member_id' AND home_status = 'N' ";
    $home_result_vwhome_no_appr2 = $conn->query($sql2);
    $home_count_vwhome_no_appr2 = $home_result_vwhome_no_appr2->num_rows;
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="box-detail-profile  minh-70">
                    ...
                    <div class="pt-3">
                        ...
                        <ul class="uk-switcher uk-margin">
                            <li>
                            <?php
                                while($home_result_query_vwhome_no_appr2 = mysqli_fetch_array($home_result_vwhome_no_appr2,MYSQLI_ASSOC)){
                                    $home_id2 = $home_result_query_vwhome_no_appr2["home_id"];
                                    
                                    $strSQL2 = "SELECT * FROM picture_home WHERE home_id = '$home_id2' AND  pic_status = 'N' limit 1  ";
                            ...
                            <div class="row py-3 bd-bt">
                                <div class="col-md-6 col-lg-4 py-3">
                                    <img src="img/home/<?php echo $pic_name_2; ?>" alt="" class="img-my-estate">
                                </div>
